...
import com.lt.flowwall.service.DownloadService;
...
public class YunBuGameDetailsXianWanActivity extends AppCompatActivity {
    ...
    private String DownUrl, account, deviceid, msaoaid, androidosv, packgeName, fileUrl = "/storage/emulated/0/game.apk";
    private String xianwanadid, xianwanSgin;
    private int limit, isOpenChecked = 1, FirstShowType = 1, isOpenRules = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xianwanadid = intent.getStringExtra("ADID");
            ...
            public void onClick(View view) {
                ...
                if (StopTime - StartTime > 300000) {
                    ...
                    try {
                        ...
                        String limitgame =     SessionSingleton.getInstance().mysp .getString("limitgame", "") +gameTitleData.getJSONObject("ADInfo").getJSONObject("baseInfo").getString("adName");
    ...
    private void initview() {
        ...
        try {
            ...
            xianwanSgin = Utils.getMD5("2" + deviceid + msaoaid + androidosv + SessionSingleton.getInstance().XianWanSingle.getString("key") + account + xianwanadid + SessionSingleton.getInstance().XianWanSingle.getString("secret"));
        ...
        getXianWanGameDetails(xianwanadid);
    ...
    //下载游戏
    private void LoadXianWangame(String adid) {
        try {
            ...
            HttpUtils.dogetHttpReqeust("https://h5.17xianwan.com/try/API/try_api_adClick?", params, new HttpUtils.StringCallback() {
                @Override
    ...
    //闲玩游戏详情
    private void getXianWanGameDetails(String adid) {
        try {
            Map<String, String> params = new HashMap<>();
            params.put("ptype", "2");
            params.put("androidosv", androidosv);
            ...
            HttpUtils.dogetHttpReqeust("https://h5.17xianwan.com/try/API/try_api_adInfo?", params, new HttpUtils.StringCallback() {
                @Override
                public void onSuccess(String response) {
                    try {
                        mLoading.dismiss();
                        ...
                        if (object.getInt("status") == 0) {
                            gameTitleData = new JSONObject(response);
                            if (gameTitleData.getJSONObject("ADInfo").getJSONObject("awardList").length() < 1) {
                                ...
                                if (gameTitleData.getJSONObject("ADInfo").getJSONObject("awardList").length() == 0) {
                                    ...
                                    if (FirstShowType == 1) {
                                        taskArray = gameTitleData.getJSONObject("ADInfo").getJSONObject("awardList").getJSONArray("award0");
                                    } else if (FirstShowType == 2) {
                                        taskArray = gameTitleData.getJSONObject("ADInfo").getJSONObject("awardList").getJSONArray("award1");
                                    } else if (FirstShowType == 3) {
                                        taskArray = gameTitleData.getJSONObject("ADInfo").getJSONObject("awardList").getJSONArray("award2");
                                    } else if (FirstShowType == 4) {
                                        taskArray = gameTitleData.getJSONArray("activityList");
                                    }
                                }
                            }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (type == 0) {
                ...
                try {
                    ...
                    JSONObject single = gameTitleData.getJSONObject("ADInfo").getJSONObject("baseInfo");
                    JSONArray array = gameTitleData.getJSONObject("ADInfo").getJSONArray("awardName");
                    JSONObject gametask = gameTitleData.getJSONObject("ADInfo").getJSONObject("awardList");
                    ...
                    if (gametask.length() == 0) {
                        ll_game_details_item_type_one.setVisibility(View.GONE);
                    ...
                    if (gameTitleData.getJSONArray("activityList").length() != 0) {
                        ...
                        if (gametask.length() == 0) {
                            ...
                            tv_game_details_item_type_three.setText(array.getString(0));
                        } else if (gametask.length() == 1) {
                            ll_game_details_item_type_one.setVisibility(View.VISIBLE);
                            ll_game_details_item_type_two.setVisibility(View.GONE);
                            ll_game_details_item_type_four.setVisibility(View.GONE);
                            ...
                            tv_game_details_item_type_one.setText(array.getString(0));
                            tv_game_details_item_type_three.setText(array.getString(1));
                        } else if (gametask.length() == 2) {
                            ll_game_details_item_type_one.setVisibility(View.VISIBLE);
                            ll_game_details_item_type_two.setVisibility(View.VISIBLE);
                            ll_game_details_item_type_four.setVisibility(View.GONE);
                            ...
                            tv_game_details_item_type_one.setText(array.getString(0));
                            tv_game_details_item_type_two.setText(array.getString(1));
                            tv_game_details_item_type_three.setText(array.getString(2));
                        } else if (gametask.length() == 3) {
                            ll_game_details_item_type_one.setVisibility(View.VISIBLE);
                            ll_game_details_item_type_two.setVisibility(View.VISIBLE);
                            ll_game_details_item_type_three.setVisibility(View.VISIBLE);
                            ...
                            tv_game_details_item_type_two.setText(array.getString(1));
                            tv_game_details_item_type_four.setText(array.getString(2));
                            tv_game_details_item_type_three.setText(array.getString(3));
                        }
                    ...
                    /// ImageLoader.getInstance().displayImage(single.getString("imgUrl"), topHolder.iv_game_details_image, customImageLoaderUtils_Circle.Corners(5));
                    ...
                    ll_game_details_item_type_four.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            tv_game_details_item_type_one_zhishiqi.setVisibility(View.GONE);
                            tv_game_details_item_type_two_zhishiqi.setVisibility(View.GONE);
                            tv_game_details_item_type_three_zhishiqi.setVisibility(View.GONE);
                            tv_game_details_item_type_four_zhishiqi.setVisibility(View.VISIBLE);

                            tv_game_details_item_type_one.setTextSize(14);
                            tv_game_details_item_type_two.setTextSize(14);
                            tv_game_details_item_type_three.setTextSize(14);
                            tv_game_details_item_type_four.setTextSize(17);

                            tv_game_details_item_type_one.setTextColor(getResources().getColor(R.color.yunbu_textgray));
                            tv_game_details_item_type_two.setTextColor(getResources().getColor(R.color.yunbu_textgray));
                            tv_game_details_item_type_three.setTextColor(getResources().getColor(R.color.yunbu_textgray));
                            tv_game_details_item_type_four.setTextColor(getResources().getColor(R.color.yunbu_textblack));
                            ...
                            try {
                                ...
                                if (tv_game_details_item_type_four.getText().toString().contains("奖励")) {
                                    ListType = "1";
                                } else if (tv_game_details_item_type_four.getText().toString().contains("充值")) {
                                    ListType = "2";
                                } else if (tv_game_details_item_type_four.getText().toString().contains("榜")) {
                                    ListType = "3";
                                } else {
                                    ListType = "1";
                                }
                ...
                if (ListType.equals("3")) {
                    ...
                    try {
                        ...
                        if (single.getString("progress").contains("已领取")) {
                        ...
                        if (ListType.equals("1")) {
                            ...
                            double money2 = money - (money * SessionSingleton.getInstance().moneyScale)
                                    +SessionSingleton.getInstance().yunbuXianWanMoneySpecialHandel;

                            BigDecimal sharemal = new BigDecimal(money2);
